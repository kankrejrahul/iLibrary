...
//        this.defaultScaleValue = newScale;
    ...
    setModelScale: function setModelScaleFn(newScale) {
        defaultScaleValue = parseFloat(newScale);
        console.log(defaultScaleValue);
    },
                ...
                */
                ...
                onScaleChanged: function(scale) {
                    ...
                    this.scale = {
                        ...
                        y: this.defaultScaleValue,
                        z: this.defaultScaleValue
                    };
                },
