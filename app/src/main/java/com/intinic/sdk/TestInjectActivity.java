...
public class TestInjectActivity extends AppCompatActivity implements View.OnClickListener
{
    protected ArchitectView architectView;
    Context context = TestInjectActivity.this;
    boolean cameraTwoEnabled = true;
    String modelToRender;
...
//    FloatingActionButton addToCart;
    ...
    void getData()
    {
        ...
        Log.d("arExperiencePath", "modelToLoad: " + modelToRender);
...
//            SAMPLES_ROOT + arExperiencePath
            ...
            String data = "clock.wt3";
            callJavaScript("World.setModelName", new String[] { data });
